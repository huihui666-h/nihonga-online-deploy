...
assert.equal(index.rotationHourKey("2026-09-02T14:59:59Z"), "2026-09-02T23", "Tokyo rotation remains stable within the hour");
assert.equal(index.rotationHourKey("2026-09-02T15:00:00Z"), "2026-09-03T00", "Tokyo rotation changes at the next hour");
assert.equal(index.rotationHourKey("invalid"), "", "Invalid timestamps cannot become rotation seeds");
