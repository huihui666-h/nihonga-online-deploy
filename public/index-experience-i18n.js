...
const experienceTranslations = {
  zh: {
    ...
    shareSearch: "分享当前筛选", shareArtist: "分享画家", shareTitle: "分享这次发现", shareLinkLabel: "分享链接", copyLink: "复制链接", copiedLink: "链接已复制", copyManually: "未能自动复制。请选中链接后手动复制。", shareHelp: "链接只包含画家或公开筛选条件，不包含账号、收藏或浏览记录。", localShareHelp: "这是本机预览链接，只能在这台电脑上打开。上线后可分享正式地址。", missingArtist: "这位画家暂时不在当前目录中，你仍可浏览其他画家。",
    favoritesScope: "当前账号 · 当前浏览器", imageTitle: "长谷川等伯《松林图屏风》局部", metaDescription: "由 HUI 整理的日本画家索引。从姓名、学校、地区与标签发现画家，在 Instagram 欣赏完整作品。",
  ...
  en: {
    ...
    favoritesScope: "This account · This browser", imageTitle: "Detail of Pine Trees by Hasegawa Tohaku", metaDescription: "A Nihonga artist index curated by HUI. Discover artists by name, school, region and tag, then explore their work on Instagram.",
  ...
  ja: {
    ...
    shareSearch: "絞り込み条件を共有", shareArtist: "作家を共有", shareTitle: "出会いを共有する", shareLinkLabel: "共有リンク", copyLink: "リンクをコピー", copiedLink: "リンクをコピーしました", copyManually: "自動コピーできませんでした。リンクを選択して手動でコピーしてください。", shareHelp: "リンクには作家や公開の検索条件のみが含まれます。アカウント・お気に入り・閲覧履歴は含まれません。", localShareHelp: "このプレビューリンクは、このパソコンでのみ開けます。公開後は本番のアドレスを共有できます。", missingArtist: "この作家は現在の一覧にありません。他の作家を引き続きご覧いただけます。",
    favoritesScope: "このアカウント · このブラウザ", imageTitle: "長谷川等伯《松林図屏風》部分", metaDescription: "HUI が選び、整理する日本画作家の索引。名前・学校・地域・タグから作家を探し、Instagram で作品を楽しめます。",
