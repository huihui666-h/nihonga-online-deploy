...
const indexTranslations = {
  zh: {
    ...
    newsHomeEyebrow: "04 / NIHONGA NOW", newsHomeTitle: "日本画新闻", newsHomeLede: "展览、公募与画家动态，及时汇集。", newsHomeMore: "查看全部新闻",
    logEyebrow: "HUI LOG", logTitle: "更新日志", logDescription: "记录画家索引如何一点点生长。", logEntryOneTitle: "Nihonga Now 上线", logEntryOneText: "新增汇集展览、公募与画家动态的日本画新闻栏目。", logEntryTwoTitle: "整理最近加入的画家", logEntryTwoText: "有加入日期时按新到旧显示，没有日期时保留清晰说明。", logEntryThreeTitle: "让搜索成为入口", logEntryThreeText: "从作家名、学校、Instagram 和关键词开始发现日本画家。",
    indexSubtitle: "从作家、题材与学校，发现日本画。", indexSearchPlaceholder: "作家名、学校、Instagram 或关键词…", browseByTag: "从标签开始",
    ...
    rankingContext: "今日站内 Instagram 链接查看记录。", aboutTitle: "从一次发现，到下一次相遇。",
    aboutDescription: "这是由 HUI 从 Instagram 发现、筛选并持续整理的日本画家索引。这里帮助你寻找和认识作家，Instagram 则是欣赏完整作品的下一站。",
    contributeTitle: "一起，让索引更好。", backToTop: "返回顶部 ↑", closeDialog: "关闭", cardDetails: "认识作家", cardOpenIG: "Instagram ↗", cardReport: "报告信息问题", sourceNote: "收录资料", cardAdded: "加入于",
  ...
  en: {
    ...
    newsHomeEyebrow: "04 / NIHONGA NOW", newsHomeTitle: "Nihonga news", newsHomeLede: "Exhibitions, open calls and artist updates, gathered in one place.", newsHomeMore: "View all news",
    logEyebrow: "HUI LOG", logTitle: "Site log", logDescription: "A record of how the artist index grows, one update at a time.", logEntryOneTitle: "Nihonga Now goes live", logEntryOneText: "A news desk for exhibitions, open calls and artist updates joins the index.", logEntryTwoTitle: "Recently added artists, clarified", logEntryTwoText: "Artists with dates sort newest first; artists without dates keep a clear explanation.", logEntryThreeTitle: "Search becomes the starting point", logEntryThreeText: "Start discovering through artist names, schools, Instagram and keywords.",
    indexSubtitle: "Discover Nihonga through artists, subjects and schools.", indexSearchPlaceholder: "Artist, school, Instagram or keyword…", browseByTag: "START WITH A TAG",
    ...
    rankingContext: "Today’s Instagram link visits from this index.", aboutTitle: "One discovery leads to another.",
    aboutDescription: "A growing index of Nihonga artists discovered and selected by HUI on Instagram. Find and get to know artists here, then visit Instagram to explore their full work.",
    contributeTitle: "Help the index grow.", backToTop: "Back to top ↑", closeDialog: "Close", cardDetails: "Meet the artist", cardOpenIG: "Instagram ↗", cardReport: "Report information", sourceNote: "Source notes", cardAdded: "Added",
  ...
  ja: {
    ...
    newsHomeEyebrow: "04 / NIHONGA NOW", newsHomeTitle: "日本画ニュース", newsHomeLede: "展覧会、公募、作家の動きを、いち早く。", newsHomeMore: "すべて見る",
    logEyebrow: "HUI LOG", logTitle: "更新記録", logDescription: "画家索引が少しずつ育っていく記録。", logEntryOneTitle: "Nihonga Now を公開", logEntryOneText: "展覧会、公募、作家動向を集める日本画ニュース欄を追加。", logEntryTwoTitle: "最近追加された作家を整理", logEntryTwoText: "追加日がある作家は新しい順に。未設定でも案内を保って表示。", logEntryThreeTitle: "検索を入口に", logEntryThreeText: "作家名、学校、Instagram、キーワードから日本画家を探せます。",
    indexSubtitle: "日本画を、作家・題材・学校から探す。", indexSearchPlaceholder: "作家名、学校、Instagram、キーワード…", browseByTag: "タグから探す",
    ...
    rankingContext: "本日の Instagram リンク閲覧記録。", aboutTitle: "ひとつの発見から、次の出会いへ。",
    aboutDescription: "HUI が Instagram で見つけ、選び、整理し続ける日本画作家の索引です。ここで作家を探し、知り、作品の続きは Instagram でご覧ください。",
    contributeTitle: "索引を、ともに育てる。", backToTop: "ページ上部へ ↑", closeDialog: "閉じる", cardDetails: "作家を知る", cardOpenIG: "Instagram ↗", cardReport: "情報の修正を報告", sourceNote: "収録メモ", cardAdded: "追加日",
    ...
    finderTitle: "どんな日本画家を探していますか？", finderDescription: "題材や雰囲気を言葉に。今後、本站に収録された実在の作家からご提案します。", finderInputLabel: "探したい作家について", finderPlaceholder: "例：人物と幻想を描く作家を探したい", finderSend: "作家を探す", finderComingSoon: "AI 日本画作家ナビは準備中です。今は検索とタグから作家を探せます。", finderPrivacy: "現在は UI プレビューです。入力は送信されません。AI 接続・リクエスト・費用は発生しません。",
    finderPrompts: ["人物画の作家", "幻想的な作家", "動物を描く作家", "東京藝術大学出身", "静かな雰囲気", "松井冬子に近い作家"]
  }
};
const indexLabels = {
  zh: {
    indexName: "画家索引", indexBrand: "画家索引", navAiFinder: "AI 找画家",
    featuredEyebrow: "01 / 精选画家", recentEyebrow: "03 / 最近加入", randomEyebrow: "随机发现", directoryEyebrow: "02 / 全部画家",
    ...
    curatedBy: "由 CHEN JUNHUI 筛选整理", welcomeSubtitle: "走进由画笔与矿物颜料织就的千年之美", enterSite: "进入", accessEyebrow: "HUI STUDIO · 访问入口",
    mainNavigation: "主导航", homeLink: "HUI STUDIO — 首页", activeFiltersLabel: "当前筛选条件", activityLabel: "索引动态", statisticsLabel: "数据统计", privateEntrance: "管理入口",
    previewNotice: "本地只读预览 · 不写入线上数据"
  },
  en: {
    indexName: "ARTIST INDEX", indexBrand: "ARTIST INDEX", navAiFinder: "AI Finder",
    featuredEyebrow: "01 / FEATURED ARTISTS", recentEyebrow: "03 / RECENTLY ADDED", randomEyebrow: "RANDOM DISCOVERY", directoryEyebrow: "02 / ALL ARTISTS",
    ...
    curatedBy: "Curated by CHEN JUNHUI", welcomeSubtitle: "Into the thousand-year beauty woven by brush and mineral pigment", enterSite: "Enter", accessEyebrow: "HUI STUDIO · ACCESS",
    mainNavigation: "Main navigation", homeLink: "HUI STUDIO — Home", activeFiltersLabel: "Active filters", activityLabel: "Index activity", statisticsLabel: "Statistics", privateEntrance: "Private entrance",
    previewNotice: "Read-only local preview · No production writes"
  },
  ja: {
    indexName: "画家索引", indexBrand: "画家索引", navAiFinder: "AI作家ナビ",
    featuredEyebrow: "01 / おすすめ作家", recentEyebrow: "03 / 最近追加された作家", randomEyebrow: "偶然の出会い", directoryEyebrow: "02 / すべての作家",
    ...
    curatedBy: "CHEN JUNHUI が選び、整理", welcomeSubtitle: "筆と岩絵具が織りなす、千年の美の世界へ", enterSite: "入る", accessEyebrow: "HUI STUDIO · 入り口",
    mainNavigation: "メインナビゲーション", homeLink: "HUI STUDIO — ホーム", activeFiltersLabel: "選択中の条件", activityLabel: "索引の動き", statisticsLabel: "収録データ", privateEntrance: "管理者入口",
