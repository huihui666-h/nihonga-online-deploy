...
const indexTranslations = {
  zh: {
    ...
    featuredTitle: "从这里开始认识", featuredDaily: "每小时从已收录画家中轮换，发现新的名字。", featuredManual: "HUI 的特别推荐，以及更多值得认识的名字。",
  ...
  en: {
    ...
    featuredTitle: "A place to begin", featuredDaily: "A new rotation from the index every hour. A few new names to discover.", featuredManual: "HUI’s featured artists, alongside more names to discover.",
  ...
  ja: {
    ...
    featuredTitle: "おすすめ作家", featuredDaily: "収録作家から1時間ごとにご紹介。新しい名前との出会いを。", featuredManual: "HUI のおすすめと、出会ってほしい作家たち。",
